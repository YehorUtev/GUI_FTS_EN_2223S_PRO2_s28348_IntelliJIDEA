...
public class DecreaseSpeedForGhost extends JPanel {
    ImageIcon boostIcon = new ImageIcon("E:\\GUI_FTS_EN_2223S_PRO2_s28348_IntelliJIDEA\\src\\images\\boost2.png");
    private int boostRow;
    private int boostColumn;
    public DecreaseSpeedForGhost(int boostRow, int boostColumn){

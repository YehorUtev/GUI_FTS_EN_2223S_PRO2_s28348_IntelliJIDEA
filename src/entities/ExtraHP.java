...
public class ExtraHP extends JPanel {
    private int boostRow;
    private int boostColumn;
    ImageIcon boostIcon = new ImageIcon("E:\\GUI_FTS_EN_2223S_PRO2_s28348_IntelliJIDEA\\src\\images\\extraHp.png");
    public ExtraHP(int boostRow, int boostColumn){
